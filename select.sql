...
SELECT title, duration FROM track ORDER BY LENGTH(duration) DESC LIMIT 1;

SELECT title FROM track WHERE duration >= '3:30';

SELECT title FROM album WHERE year BETWEEN 2018 AND 2020;
